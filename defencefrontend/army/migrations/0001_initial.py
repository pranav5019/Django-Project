    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TSHIRT', 'T-shirt'), ('PANT', 'Pant'), ('SHOES', 'Shoes'), ('WATCH', 'Watch'), ('JACKET', 'Jacket'), ('BAGS', 'Bags')], max_length=20)),
                ('small_description', models.CharField(max_length=300)),
                ('description', models.TextField()),
                ('selling_price', models.IntegerField()),
                ('discounted_price', models.IntegerField()),
                ('storeimages', models.ImageField(upload_to='storeimages')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('pet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='army.pet')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(default=1)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='army.pet')),
            ],
        ),
    ]

...
def checkout(request):
    ...
    for item in cart_items:
        ...
        'amount': final_price_with_gst,    #: The amount of money to be charged for the transaction. 
        'item_name': 'Store',       # Describes the item being purchased.
  ...
  #================= Paypal Code  End =====================
    ...
    return render(request, 'checkout.html', {'cart_items': cart_items,'total':total,'final_price':final_price ,'final_price_with_gst':final_price_with_gst,'address':address,'paypal':paypal_payment})
...
def paymentfailed(request):
    ...
    # cart_items will fetch product of current user, and show product available in the cart of the current user.

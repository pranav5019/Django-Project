...
urlpatterns = [
    ...
    path('myorder',views.order,name='myorder'),
    ...
    path('paymentsuccess/<int:selected_address_id>/',views.payment_success,name='paymentsuccess'),
    path('paymentfailed/',views.payment_failed,name='paymentfailed'),
    # path('order/',views.order,name='order'),
    path('buynow<int:id>',views.buynow,name='buynow'),
    path('buynowpayment<int:id>',views.buynow_payment,name='buynowpayment'),
    path('buynowpaymentsuccess/<int:selected_address_id>/<int:id>',views.buynow_payment_success,name='buynowpaymentsuccess'),
